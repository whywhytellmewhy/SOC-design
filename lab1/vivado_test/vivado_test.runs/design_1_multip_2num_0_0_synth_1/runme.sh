...
HD_PWD='/home/ubuntu/course-lab_1/vivado_test/vivado_test.runs/design_1_multip_2num_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_multip_2num_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_multip_2num_0_0.tcl
