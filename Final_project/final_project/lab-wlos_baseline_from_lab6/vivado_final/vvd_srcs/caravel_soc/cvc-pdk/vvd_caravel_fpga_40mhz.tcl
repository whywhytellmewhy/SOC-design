...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/soc/pads.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/multiplier_adder.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/DMA_FIR.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/mm.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/DMA_MM.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/sdram_arbiter.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB_to_controller.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB_decoder.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/sdram_branch.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/cvc-pdk/cvc-pdk/sky130_sram_2kbyte_1rw1r_32x512_8.v.v"]"\
  ]
  foreach ifile $files {
...
set files [list \
  ...
  [file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/header/user_defines.v"]\
  [file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/header/defines.v"]\
  [file normalize "$origin_dir/vvd_srcs/caravel_soc/cvc-pdk/cvc-pdk/sky130_sram_2kbyte_1rw1r_32x512_8.v"]\
]
