...
/////	reg_mprj_datal = 0xAB600000;
	...
	/////reg_mprj_datal = 0xAB510000;
	/////reg_mprj_datal = 0xAB610000; // Modified in order to "indicate which part of code is running" --> we move this to isr.c

////// We move this part to some former position, in order to "enable irq as early as possible (so that we won't lose uart rx interrupt)" /////
/*#ifdef USER_PROJ_IRQ0_EN	
	// unmask USER_IRQ_0_INTERRUPT
	mask = irq_getmask();
	mask |= 1 << USER_IRQ_0_INTERRUPT; // USER_IRQ_0_INTERRUPT = 2
