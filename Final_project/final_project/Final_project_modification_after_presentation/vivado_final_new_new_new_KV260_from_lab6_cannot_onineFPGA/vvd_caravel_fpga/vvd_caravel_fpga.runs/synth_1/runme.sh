...
HD_PWD='/home/ubuntu/final_project/Final_project_modification_after_presentation/vivado_final_new_new_new_KV260_from_lab6/vvd_caravel_fpga/vvd_caravel_fpga.runs/synth_1'
cd "$HD_PWD"
