# 0 "qsort.c"
# 1 "/home/ubuntu/final_project/Final_project_modification_after_presentation/testbench/counter_la_final//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "qsort.c"
# 1 "qsort.h" 1
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) hardware_accelerator_initialization(){
 ...
 WB_return_data = *((int*)0x30000000);
 while (((WB_return_data>>2)&1)==0){
  WB_return_data = *((int*)0x30000000);
 }


 *((int*)(0x30000000 +0x10))=64;
 for(i=0; i<11; i=i+1){
  *((int*)(0x30000000 +0x20+4*i))=taps[i];
 }


 *((int*)(0x30000000 +0x88))=(int)(&x);
