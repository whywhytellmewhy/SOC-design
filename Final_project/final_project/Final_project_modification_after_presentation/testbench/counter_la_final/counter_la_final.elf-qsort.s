...
.Ltext0:
	...
	.file 0 "/home/ubuntu/final_project/Final_project_modification_after_presentation/testbench/counter_la_final" "qsort.c"
...
.LVL34:
	...
	.loc 1 123 32 is_stmt 0
	andi	a5,a5,64
.LVL35:
	.loc 1 123 32 is_stmt 1
	bne	a5,zero,.L31
.L30:
	j	.L30
.L31:
	...
	lui	a0,%hi(.LANCHOR1+252)
	addi	a0,a0,%lo(.LANCHOR1+252)
	ret
	.cfi_endproc
.LFE321:
...
.LVL36:
	...
	.loc 1 139 32 is_stmt 0
	andi	a5,a5,64
.LVL37:
	.loc 1 139 32 is_stmt 1
	bne	a5,zero,.L36
.L35:
	j	.L35
.L36:
	...
	lui	a0,%hi(.LANCHOR0+144)
	addi	a0,a0,%lo(.LANCHOR0+144)
	ret
	.cfi_endproc
.LFE322:
