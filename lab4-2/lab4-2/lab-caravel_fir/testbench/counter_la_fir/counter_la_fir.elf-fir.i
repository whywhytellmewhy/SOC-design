# 0 "fir.c"
# 1 "/home/ubuntu/lab4-2/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "fir.c"
# 1 "fir.h" 1
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){
 ...
 for (int i = 0; i < 64; i=i+1) {
  ...
  for (int j = 0; j < 11; j=j+1) {
   if (i>=64 -11){
    outputsignal[i-(64 -11)] = outputsignal[i-(64 -11)] + taps[j]*inputbuffer[data_RAM_pointer];
   }
...
# 80 "fir.c"
 ...
 if (times==1){
  ...
  WB_write((int*)(0x30000000 +0x10), 64);
  for(i=0; i<11; i=i+1){
